...
parser.add_argument("--net", type=str, default='STRING', help='Net type')
parser.add_argument("--num", type=int, default=500, help='Number of Genes')
...
exp_file = 'Dataset/Benchmark Dataset/' + net_type + ' Dataset/' + data_type+'/TFs+'+str(num)+'/BL--ExpressionData.csv'
tf_file = 'Dataset/Benchmark Dataset/' + net_type + ' Dataset/' + data_type+'/TFs+'+str(num)+'/TF.csv'
target_file = 'Dataset/Benchmark Dataset/' + net_type + ' Dataset/' + data_type+'/TFs+'+str(num)+'/Target.csv'
...
train_file = 'Dataset/Benchmark Dataset/Train/' + net_type + '/' +data_type+' '+str(num)+'/Train_set.csv'
test_file = 'Dataset/Benchmark Dataset/Train/' + net_type + '/' +data_type+' '+str(num)+'/Test_set.csv'
val_file = 'Dataset/Benchmark Dataset/Train/' + net_type + '/' +data_type+' '+str(num)+'/Validation_set.csv'
...
print('Net type:{}, Data: {} {}, AUC:{}, AUPRC:{}'.format(net_type, data_type, num, AUC, AUPR))
