...
# 'ASC',
for data_type in ['ASC', 'EDC', 'MGL', 'OL', 'OPC', 'PVALB', 'RELN', 'SST', 'VIP', 'VLMC']:
# for data_type in ['OL', 'SST']:
    ...
    edge_paths = {'train': edge_root_path + '/Train_set.csv', #'/Train_set_sample.csv',
    ...
    with open('new_results/' + model_name + '_mouse_results.txt', 'a+') as f:
