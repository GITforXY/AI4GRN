...
for data_type in ['AST', 'MIC', 'ODC', 'OPC', 'SST', 'VIP']:
# for data_type in ['ODC']:

    param_str = f"human_{data_type}_{args.model}_epochs{args.n_epochs}_layers{args.num_layers}"
    if args.use_gatv2:
        param_str += "_GATv2"
    if args.use_feature:
        param_str += "_feat"
    ...
    if args.pre_model == 'simba':
        ...
        feat_path = '/mnt/data/oss_beijing/xieyong/datasets/model_data/Expressions/' + \
    ...
    edge_root_path = '/mnt/data/oss_beijing/xieyong/datasets/model_data/Data_Split_1_1/'+ \
               data_type
    ...
    with open('new_results/' + model_name + '_human_results.txt', 'a+') as f:
        f.write("Median test auc for model {}, pre_model {}, omics {}, lr {}, layers {}, feature_dim {}, embedding_dim {}, data {} is: {}\n".
                format(args.model, args.pre_model, args.omics, args.lr, args.num_layers, args.feature_dim, args.hidden_channels, data_type, np.median(all_runs)))
