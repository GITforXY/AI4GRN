...
class DGCNN(torch.nn.Module):
    def __init__(self, hidden_channels, num_layers, max_z, num_features, use_ignn=False,
                 k=10, GNN=GCNConv, NGNN=NGNN_GCNConv, use_feature=False, node_embedding=None):
...
class DGCNN_feat(torch.nn.Module):
    def __init__(self, hidden_channels, num_layers, max_z, num_features, use_ignn=False,
                 k=10, GNN=GCNConv, NGNN=NGNN_GCNConv, node_embedding=None):
